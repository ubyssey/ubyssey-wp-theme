<?php
/**
 * Template Name: Full Width (with opening slide)
 */
?>
...
<div id="page-dark">
    ...
    <?php 
        if(!$image = get_post_meta( get_the_ID(), 'extra_image', true)){
    ...
    <div class="l-content clearfix">
        <div class="l-fullwidth-story dark single">
            ...
            <div class="slide-cover-container full-height">
                ...
                <div class="slide-cover">
                    <div class="headers-container">
                        <div class="slide-headers">
                            <span class="l-fullwidth-story date"><?php the_time('F j, Y'); ?></span>
                            <h1 class="l-fullwidth-story title"><?php the_title(); ?></h1>
                            <span class="l-fullwidth-story author">By <?php the_author(); ?></a></span><br/>
                            <div class="l-fullwidth-story photos"><?php echo get_post_meta(get_the_ID(), 'extra_credit', true); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="l-fullwidth-banner">
