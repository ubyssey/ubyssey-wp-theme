<?php
/*
 * The section front for the features post type.
 */
get_header(); ?>
    <div class="l-content l-contained clearfix">
            ...
            <div class="section-featured clearfix">
                ...
                <div class="content">
                    <?php
                        ...
                        $count = 0;
                        // Get the 2 most recent features article with 'features-feature' category
                        $args = array( 'posts_per_page' => '2', 'post_type' => 'features', 'feature_category' => 'features-featured');
                        // The Query
                ...
                <div class="content clearfix">
                    <section class="featured">
                        <?php
                            ...
                            $args = array( 'posts_per_page' => '1', 'post_type' => 'features', 'feature_category' => 'features-editors' );
                            // The Query
                            $the_query = new WP_Query( $args );
                            // The Loop
                            while ( $the_query->have_posts() ) : $the_query->the_post();
                    ...
                    <nav class="section-feed">
                        <ul>
                            <?php
                                ...
                                $to_exclude = new WP_Query( array( 'posts_per_page' => '1', 'post_type' => 'features', 'feature_category' => 'features-editors' ) );
                                wp_reset_postdata();
                                ...
                                $args = array( 'posts_per_page' => '4', 'post_type' => 'features', 'feature_category' => 'features-editors', 'post__not_in' => $to_exclude );
                                // The Query
                                $the_query = new WP_Query( $args );
                                // The Loop
                                while ( $the_query->have_posts() ) : $the_query->the_post();
        ...
        <?php endif; ?>
            ...
            <div class="small-feed recent-feed">
                ...
                <?php ub_content_nav( 'features-nav' ); ?>
