...
get_header(); ?>
    <div class="l-main section-front">
        <?php if ( have_posts() ) : ?>
            ...
            <?php
                //Queue the first post, that way we know what author we're dealing with (if that is the case).  We reset this later so we can run the loop properly with a call to rewind_posts().
                the_post();
            ?>
