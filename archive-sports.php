<?php
/*
 * The section front for the Sports post type.
 *
 */
get_header(); ?>
			...
			<div class="section-featured clearfix">
				...
				<div class="content">
					<?php
						...
						$count = 0;	
						// Get the 2 most recent sports article with 'sports-feature' category
						$args = array( 'posts_per_page' => '2', 'post_type' => 'sports', 'sports_category' => 'sports-featured');
						// The Query
				...
				<div class="content clearfix">
					<section class="featured">
						<?php
							...
							$args = array( 'posts_per_page' => '1', 'post_type' => 'sports', 'sports_category' => 'sports-editors' );
							// The Query
							$the_query = new WP_Query( $args );
							// The Loop
							while ( $the_query->have_posts() ) : $the_query->the_post();
					...
					<nav class="section-feed">
						<ul>
							<?php
								...
								$to_exclude = new WP_Query( array( 'posts_per_page' => '1', 'post_type' => 'sports', 'sports_category' => 'sports-editors' ) );
								wp_reset_postdata();
								...
								$args = array( 'posts_per_page' => '4', 'post_type' => 'sports', 'sports_category' => 'sports-editors', 'post__not_in' => $to_exclude );
								// The Query
								$the_query = new WP_Query( $args );
								// The Loop
								while ( $the_query->have_posts() ) : $the_query->the_post();
